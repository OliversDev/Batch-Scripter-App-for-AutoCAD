...
namespace Batch_Scripter
{
    internal static class BatchScripterTheme
    {
            ...
            PictureBox linkedIn)
        {
            ...
            ApplyDazzleIcon(gitHub, "Batch_Scripter.Dazzle.Github-logo.png", socialIconColour);
            ApplyDazzleIcon(linkedIn, "Batch_Scripter.Dazzle.Linkedin-logo.png", socialIconColour);
        }
        ...
        private static void ApplyDazzleIcon(PictureBox pictureBox, string resourceName, Color colour)
        {
            try
            {
                using (Stream stream = typeof(BatchScripterTheme).Assembly
